#ifndef MJPC_TASKS_QUADRUPED_RFMPC_H
#define MJPC_TASKS_QUADRUPED_RFMPC_H
...
class RFMPC : public ThreadSafeTask {
 public:
  ...
  class ResidualFn : public mjpc::BaseResidualFn {
    public:
      explicit ResidualFn(const RFMPC* task)
    ...
    private:
      ...
      //  ============  constants  ============
      constexpr static RFMPCFoot kFootAll[kNumFoot] = {kFootFL, kFootHL,
                                                    kFootFR, kFootHR};
      constexpr static RFMPCFoot kFootHind[2] = {kFootHL, kFootHR};
      constexpr static RFMPCGait kGaitAll[kNumGait] = { kGaitStand, kGaitWalk, kGaitTrot};
      ...
      void FootStep(double step[kNumFoot], double time, RFMPCGait gait) const;
      ...
      RFMPCMode current_mode_ = kModeQuadruped;
...
#endif  // MJPC_TASKS_QUADRUPED_RFMPC_H_
